...
export const Footer = () => {
  return (
    <footer className="relative border-t border-blue-900 flex flex-col items-center justify-center py-12 text-center">
      <div className="absolute inset-0 bg-gradient-to-t from-blue-400 to-blue-500 opacity-10 backdrop-blur-xl z-0" />
