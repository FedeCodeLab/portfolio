...
const buttonVariants = cva(
  "group flex items-center justify-center gap-2 font-pixelifySans whitespace-nowrap rounded-[50px] cursor-pointer transition-colors duration-500 font-[500]",
  {
    variants: {
      variant: {
        default:
          "border border-transparent dark:border-blue-700 bg-[#3098F3] dark:bg-blue-800 hover:bg-blue-700 dark:hover:bg-blue-900 text-white",
        ghost:
          "border-2 border-transparent dark:border-[#3098F3] dark:border-blue-700 hover:border-blue-700 dark:hover:border-blue-900",
        ghostGray:
