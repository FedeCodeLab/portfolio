...
export const MenuMobile = () => {
  ...
  return (
    <div
      className={`fixed lg:hidden top-0 right-0 h-dvh w-full bg-white dark:bg-[#0b0d18] transform transition-transform duration-300 ease-in-out flex flex-col justify-between ${
